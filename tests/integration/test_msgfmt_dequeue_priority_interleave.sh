...
for e in $ENGINES; do
  ...
  dA=$(fcall "$e" msgfmt_dequeue 2 "$q" "$pfx" 1000 30000)
  ...
  fcall "$e" msgfmt_enqueue 2 "$q" "${pfx}C" C 3 Priority 20 Payload PAY-C >/dev/null
  ...
  dB=$(fcall "$e" msgfmt_dequeue 2 "$q" "$pfx" 1001 30000)
  ...
  dC=$(fcall "$e" msgfmt_dequeue 2 "$q" "$pfx" 1002 30000)
  ...
  dNull=$(fcall "$e" msgfmt_dequeue 2 "$q" "$pfx" 1003 30000)
