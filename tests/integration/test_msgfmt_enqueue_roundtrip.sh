...
for e in $ENGINES; do
  ...
  fcall "$e" msgfmt_enqueue 2 "pq:{o1}" "pq:{o1}:m:low" low 1 Priority 1000 >/dev/null
  fcall "$e" msgfmt_enqueue 2 "pq:{o1}" "pq:{o1}:m:mid" mid 2 Priority 100  >/dev/null
  fcall "$e" msgfmt_enqueue 2 "pq:{o1}" "pq:{o1}:m:hi"  hi  3 Priority 5    >/dev/null
  fcall "$e" msgfmt_enqueue 2 "pq:{o1}" "pq:{o1}:m:min" min 4 Priority -9007199254740992 >/dev/null
  fcall "$e" msgfmt_enqueue 2 "pq:{o1}" "pq:{o1}:m:max" max 5 Priority 9007199254740992  >/dev/null
  ...
  fcall "$e" msgfmt_enqueue 2 "pq:{f1}" "pq:{f1}:m:b" b 11 Priority 50 >/dev/null
  fcall "$e" msgfmt_enqueue 2 "pq:{f1}" "pq:{f1}:m:a" a 10 Priority 50 >/dev/null
  fcall "$e" msgfmt_enqueue 2 "pq:{f1}" "pq:{f1}:m:c" c 12 Priority 50 >/dev/null
  ...
  fcall "$e" msgfmt_enqueue 2 "pq:{r1}" "pq:{r1}:m:1" 1 1 Payload order-42 Priority 5 >/dev/null
  msg=$(fcall_ro "$e" msgfmt_read 1 "pq:{r1}:m:1")
