#!/usr/bin/env bash
#
# Convenience runner for the whole message_format test suite (Features 001 + 002).
...
#
# Usage:
#   tests/run_all.sh                 # all suites on redis + valkey (standalone)
#   ENGINES=redis tests/run_all.sh   # single engine
#   tests/run_all.sh --no-static     # skip the static portability gate
#
