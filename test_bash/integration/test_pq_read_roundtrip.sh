...
for e in $ENGINES; do
  ...
  fcall "$e" pq_create 1 "q:{rt}" DirtyBit false ReadDateTime 1700000000000 Priority -5 >/dev/null

  out=$(fcall_ro "$e" pq_read 1 "q:{rt}")
  ...
  fcall "$e" pq_create 1 "q:{rt2}" DirtyBit 1 >/dev/null
